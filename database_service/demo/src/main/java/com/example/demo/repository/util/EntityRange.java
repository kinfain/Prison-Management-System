...
public class EntityRange<E> implements Serializable {
  ...
  public EntityRange(String field) {
    this.field = field;
  }
 
 
  public EntityRange(String field, Comparable from, Comparable to) {
    this.field = field;
    this.from = from;
    this.to = to;
  }
 
  public EntityRange(String field, Comparable from, Comparable to, Boolean includeNull) {
    this.field = field;
    this.from = from;
    this.to = to;
  ...
  public EntityRange(EntityRange<E> other) {
